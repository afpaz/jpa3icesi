...
public class DialogoEditarSesion extends Dialog {
	...
	public DialogoEditarSesion(TabPlanificador tabPlanificador) {
		setModal(true);
		setHeading(MultiLingualConstants.dialogoEditarSesion_heading());
	...
	public void cargarDatos(SesionModel model) {
